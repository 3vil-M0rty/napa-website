...
export const SLIDES = [
  ...
  {
    background: '/images/cocktail5.webp',
    mobileBackground: '/images/cocktail5.webp',
    titleKey: 'experience.slides.oneone.title',
    subKey: 'experience.slides.oneone.sub',
    img: '/images/simone.webp',
    mobileImg: '/images/simone.webp',
    altKey: 'experience.slides.oneone.imgAlt',
    altFallback: 'Intimate candlelit dining room at NAPA Chapter One',
    bgAlt: 'NAPA Chapter One dining room',
    slug: 'intimate-escape',
    navId: 'experience-intimate-escape',
